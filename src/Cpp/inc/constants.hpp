...
namespace constants
{
    ...
    inline constexpr int NN_VECTOR_SIZE = 68;
    inline constexpr int NN_INPUT_SIZE = 60;
    inline constexpr int LEGAL_ACTION_COUNT = 7;
    ...
    inline constexpr std::array<Action, LEGAL_ACTION_COUNT> Legal_Actions
    {
        Action::All_In,
        Action::Bet,
        Action::Call,
